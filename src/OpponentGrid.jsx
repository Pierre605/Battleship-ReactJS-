...
import './Grid.css'
import { algo_ships, ships, your_emos, algo_emos} from './Ships'
...
class OpponentGrid extends React.Component {
    ...
    Stop_interval = (Timer) => {
        let stop_button = document.getElementById('stop_interval')
        stop_button.style.cssFloat = 'right'
        stop_button.onclick = () => {
            console.log('STOP')
            clearInterval(Timer)
        }
    ...
    On_Trigger = (cell_id) => {
        const Timer = setInterval(() => {
                        this.Algo_you_player();
                        setTimeout(() => {this.Algo_player()}, 20);
                    }, 150);
        
        this.Stop_interval(Timer);

        if (this.Check_defeat_algo(this.state.opponent_grid) || this.Check_defeat_you(this.state.your_grid, this.state.opponent_grid)) {
            this.Auto_stop(Timer)
           }
        ...
        //                 text = sunk_text
        //             }
        //             this.Check_defeat_algo(algo_grid)
        //             this.DisplayYourShootReport(text);
        //         }
        //     }
        // }
    ...
    Algo_you_player = () => {
        ...
        let count_miss = 0;
        let coord_strike = [];
        let coord_your_hit = this.state.coord_your_hit;
        let text = '';
        
        for (let i=0; i < grid.length; i++) {
            if ((algo_grid[i].display === '💥')) {
                coord_strike.push(algo_grid[i].id[0]*10 + algo_grid[i].id[1])
                count_strike += 1
            }
            if ((algo_grid[i].display === '🌀')) {
                count_miss += 1
        ...
        console.log("count your strike:", count_strike)
        console.log("count your miss:", count_miss)

        
        if (count_strike === 0) {
            coord_your_hit = []
            console.log("coord_your_hit:", coord_your_hit)
    
            for (let i=0; i < grid.length; i++) {
                if ((algo_grid[i].display === null) || (algo_emos.includes(algo_grid[i].display))) { 
                    available.push(algo_grid[i])
                }
            }
            console.log("you_available_list:", available)
            ...
            for (let i=0; i < r_idx.length; i++) {
                    const isship = (element) => element['emo'] === algo_grid[r_idx[i]].valeur;

                    if (algo_emos.includes(algo_grid[r_idx[i]].valeur)) {
                        algo_grid[r_idx[i]].display = '💥'
                        let indx_ship = algo_ships.findIndex(isship)
                        console.log(indx_ship)
                        algo_ships[indx_ship]['hit'] += 1
                        console.log(algo_ships[indx_ship]['name'], 'hit:', algo_ships[indx_ship]['hit'])
                        text = `Votre ${algo_ships[indx_ship]['name']} est touché 🤕`
                        coord_your_hit.push(r_idx[i])
                        break
                    }
                    
                    else if (algo_grid[r_idx[i]].valeur === null) {
                        ...
                        if ((available.length >=85) || ((available.length < 72) && (!(available.length < 62)))) {
                            ...
                            // middle
                            if ((algo_grid[r_idx[i]].id[0] > 0) && (algo_grid[r_idx[i]].id[0] < 9) && (algo_grid[r_idx[i]].id[1] > 0) && (algo_grid[r_idx[i]].id[1] < 9)) {
                                if ((algo_emos.includes(algo_grid[r_idx[i] + 10].display) || algo_grid[r_idx[i] + 10].display === null) && (algo_emos.includes(algo_grid[r_idx[i] - 10].display) || algo_grid[r_idx[i] - 10].display === null) && (algo_emos.includes(algo_grid[r_idx[i] + 1].display) || algo_grid[r_idx[i] + 1].display === null) && (algo_emos.includes(algo_grid[r_idx[i] - 1].display) || algo_grid[r_idx[i] - 1].display === null)) {
                                    // console.log("SHOOT MIDDLE OF BLANK:", algo_grid[r_idx[i]].id);
                                    algo_grid[r_idx[i]].display = '🌀';
                                    text = '';
                                    break
                                }
                                else {
                                    // console.log('NOT SPREAD ENOUGH:', algo_grid[r_idx[i]].id)
                                }
                            }
                            // top left corner
                            else if ((algo_grid[r_idx[i]].id[0] === 0) && (algo_grid[r_idx[i]].id[1] === 0)) {
                                if ((algo_emos.includes(algo_grid[r_idx[i] + 10].display) || algo_grid[r_idx[i] + 10].display === null) &&(algo_emos.includes(algo_grid[r_idx[i] + 1].display) || algo_grid[r_idx[i] + 1].display === null)) {
                                    // console.log("SHOOT MIDDLE OF BLANK:", algo_grid[r_idx[i]].id);
                                    algo_grid[r_idx[i]].display = '🌀';
                                    text = '';
                                    break
                            ...
                            // top right corner
                            else if ((algo_grid[r_idx[i]].id[0] === 0) && (algo_grid[r_idx[i]].id[1] === 9)) {
                                if ((algo_emos.includes(algo_grid[r_idx[i] + 10].display) || algo_grid[r_idx[i] + 10].display === null) &&(algo_emos.includes(algo_grid[r_idx[i] - 1].display) || algo_grid[r_idx[i] - 1].display === null)) {
                                    // console.log("SHOOT MIDDLE OF BLANK:", algo_grid[r_idx[i]].id);
                                    algo_grid[r_idx[i]].display = '🌀';
                                    text = '';
                            ...
                            // down left corner
                            else if ((algo_grid[r_idx[i]].id[0] === 9) && (algo_grid[r_idx[i]].id[1] === 0)) {
                                if ((algo_emos.includes(algo_grid[r_idx[i] - 10].display) || algo_grid[r_idx[i] - 10].display === null) && (algo_emos.includes(algo_grid[r_idx[i] + 1].display) || algo_grid[r_idx[i] + 1].display === null)) {
                                    // console.log("SHOOT MIDDLE OF BLANK:", algo_grid[r_idx[i]].id);
                                    algo_grid[r_idx[i]].display = '🌀';
                                    text = '';
                            ...
                            // down right corner
                            else if ((algo_grid[r_idx[i]].id[0] === 9) && (algo_grid[r_idx[i]].id[1] === 9)) {
                                if ((algo_emos.includes(algo_grid[r_idx[i] - 10].display) || algo_grid[r_idx[i] - 10].display === null) &&(algo_emos.includes(algo_grid[r_idx[i] - 1].display) || algo_grid[r_idx[i] - 1].display === null)) {
                                    // console.log("SHOOT MIDDLE OF BLANK:", algo_grid[r_idx[i]].id);
                                    algo_grid[r_idx[i]].display = '🌀';
                                    text = '';
                            ...
                            // top edge
                            else if (algo_grid[r_idx[i]].id[0] === 0) {
                                if ((algo_emos.includes(algo_grid[r_idx[i] + 10].display) || algo_grid[r_idx[i] + 10].display === null) && (algo_emos.includes(algo_grid[r_idx[i] + 1].display) || algo_grid[r_idx[i] + 1].display === null) && (algo_emos.includes(algo_grid[r_idx[i] - 1].display) || algo_grid[r_idx[i] - 1].display === null)) {
                                    // console.log("SHOOT MIDDLE OF BLANK:", algo_grid[r_idx[i]].id);
                                    algo_grid[r_idx[i]].display = '🌀';
                                    text = '';
                                    break
                            ...
                            // down edge
                            else if (algo_grid[r_idx[i]].id[0] === 9) {
                                if ((algo_emos.includes(algo_grid[r_idx[i] - 10].display) || algo_grid[r_idx[i] - 10].display === null) && (algo_emos.includes(algo_grid[r_idx[i] + 1].display) || algo_grid[r_idx[i] + 1].display === null) && (algo_emos.includes(algo_grid[r_idx[i] - 1].display) || algo_grid[r_idx[i] - 1].display === null)) {
                                    // console.log("SHOOT MIDDLE OF BLANK:", algo_grid[r_idx[i]].id);
                                    algo_grid[r_idx[i]].display = '🌀';
                                    text = '';
                            ...
                            // left edge
                            else if (algo_grid[r_idx[i]].id[1] === 0) {
                                if ((algo_emos.includes(algo_grid[r_idx[i] + 10].display) || algo_grid[r_idx[i] + 10].display === null) && (algo_emos.includes(algo_grid[r_idx[i] - 10].display) || algo_grid[r_idx[i] - 10].display === null) && (algo_emos.includes(algo_grid[r_idx[i] + 1].display) || algo_grid[r_idx[i] + 1].display === null)) {
                                    // console.log("SHOOT MIDDLE OF BLANK:", algo_grid[r_idx[i]].id);
                                    algo_grid[r_idx[i]].display = '🌀';
                                    text = '';
                                    break
                            ...
                            // right edge
                            else if (algo_grid[r_idx[i]].id[1] === 9) {
                                if ((algo_emos.includes(algo_grid[r_idx[i] + 10].display) || algo_grid[r_idx[i] + 10].display === null) && (algo_emos.includes(algo_grid[r_idx[i] - 10].display) || algo_grid[r_idx[i] - 10].display === null) &&(algo_emos.includes(algo_grid[r_idx[i] - 1].display) || algo_grid[r_idx[i] - 1].display === null)) {
                                    // console.log("SHOOT MIDDLE OF BLANK:", algo_grid[r_idx[i]].id);
                                    algo_grid[r_idx[i]].display = '🌀';
                                    text = '';
                        ...
                        // fully null surrounded avoid
                            ...
                            // middle
                            if ((algo_grid[r_idx[i]].id[0] > 0) && (algo_grid[r_idx[i]].id[0] < 9) && (algo_grid[r_idx[i]].id[1] > 0) && (algo_grid[r_idx[i]].id[1] < 9)) {
                                if ((['🌀', '☠️'].includes(algo_grid[r_idx[i] + 10].display)) && ['🌀', '☠️'].includes(algo_grid[r_idx[i] - 10].display) && ['🌀', '☠️'].includes(algo_grid[r_idx[i] + 1].display) && ['🌀', '☠️'].includes(algo_grid[r_idx[i] - 1].display)) {
                                    console.log("USELESS SHOOT:", algo_grid[r_idx[i]].id);
                                }
                                else {
                                    algo_grid[r_idx[i]].display = '🌀';
                                    text = '';
                            ...
                            // top left corner
                                ...
                                if ((['🌀', '☠️'].includes(algo_grid[r_idx[i] + 10].display)) && ['🌀', '☠️'].includes(algo_grid[r_idx[i] + 1].display)) {
                                    console.log("USELESS SHOOT:", algo_grid[r_idx[i]].id);
                                }
                                else {
                                    algo_grid[r_idx[i]].display = '🌀';
                            ...
                            // top edge
                                ...
                                if ((['🌀', '☠️'].includes(algo_grid[r_idx[i] + 10].display)) && ['🌀', '☠️'].includes(algo_grid[r_idx[i] + 1].display) && ['🌀', '☠️'].includes(algo_grid[r_idx[i] - 1].display)) {
                                    console.log("USELESS SHOOT:", algo_grid[r_idx[i]].id);
                                }
                                else {
                                    algo_grid[r_idx[i]].display = '🌀';
                            ...
                            // left edge
                                ...
                                if ((['🌀', '☠️'].includes(algo_grid[r_idx[i] + 10].display)) && ['🌀', '☠️'].includes(algo_grid[r_idx[i] - 10].display) && ['🌀', '☠️'].includes(algo_grid[r_idx[i] + 1].display)) {
                                    console.log("USELESS SHOOT:", algo_grid[r_idx[i]].id);
                                }
                                else {
                                    algo_grid[r_idx[i]].display = '🌀';
            ...
            let i = coord_your_hit[coord_your_hit.length - 1]
            // console.log("coord_hit_ref:", i)
            // console.log("coord_strike:", coord_strike)

            for (const ship of algo_ships) {
                // Vertical
                if ((algo_grid[i].id[0] > 0) && (algo_grid[i].id[0] < 9))   {
                    if ((algo_grid[i + 10].display !== '🌀') && (algo_grid[i + 10].display !== '☠️')) {
                        if (algo_grid[i +10].valeur === ship.emo) {
                            ship.hit += 1
                            console.log(`${ship.hit} hit`)
                            console.log(`${ship.name} ennemi est touché`)
                            text = `${ship.name} ennemi est touché 🤕`
                            algo_grid[i +10].display = '💥'
                            coord_your_hit.push(i + 10)
                            let sunk = this.Check_sunk_you(algo_grid, ship, coord_your_hit)
                            if (sunk) {
                                text = sunk[0];
                                coord_your_hit = sunk[1]
                            }
                            this.Check_defeat_algo(algo_grid)
                            this.DisplayYourShootReport(text);
                            break
                        }
                        else if (algo_grid[i +10].valeur === null) {
                            algo_grid[i +10].display = '🌀';
                            text = '';
                            break
                        }
                    }
                    else if ((algo_grid[i - 10].display !== '🌀') && (algo_grid[i - 10].display !== '☠️')) {
                        if (algo_grid[i - 10].valeur === ship.emo) {
                            ship.hit += 1
                            console.log(`${ship.hit} hit`)
                            console.log(`${ship.name} ennemi est touché`)
                ...
                // Horizontal
                if ((algo_grid[i].id[1] > 0) && (algo_grid[i].id[1] < 9)) {
                    if ((algo_grid[i + 1].display !== '🌀') && (algo_grid[i + 1].display !== '☠️')) {
                        if (algo_grid[i + 1].valeur === ship.emo) {
                            ship.hit += 1
                            console.log(`${ship.hit} hit`)
                            console.log(`${ship.name} ennemi est touché`)
                            text = `${ship.name} ennemi est touché 🤕`
                            algo_grid[i + 1].display = '💥'
                            coord_your_hit.push(i + 1)
                            let sunk = this.Check_sunk_you(algo_grid, ship, coord_your_hit)
                            if (sunk) {
                                text = sunk[0];
                                coord_your_hit = sunk[1]
                        ...
                        else if (algo_grid[i + 1].valeur === null) {
                            algo_grid[i + 1].display = '🌀';
                            text = '';;
                            text = '';
                            break
                    ...
                    else if ((algo_grid[i - 1].display !== '🌀') && (algo_grid[i - 1].display !== '☠️')) {
                        if ((algo_grid[i - 1].valeur === ship.emo) && (algo_grid[i - 1].display !== '☠️')) {
                            ship.hit += 1
                            console.log(`${ship.hit} hit`)
                            console.log(`${ship.name} ennemi est touché`)
                            text = `${ship.name} ennemi est touché 🤕`
        ...
        // console.log("coord_hit:", coord_hit)
            ...
            for (const ship of algo_ships) {
                ...
                if ((algo_grid[i].id[0] > 0) && (algo_grid[i].id[0] < 9)) {
                    ...
                    if ((algo_grid[i - 10].display === '💥') && ((algo_grid[i + 10].display !== '🌀') && (algo_grid[i + 10].display !== '☠️'))) {
                        if (algo_grid[i + 10].valeur === ship.emo) {
                            ...
                            break
                                ...
                                coord_your_hit = coord_your_hit.reverse()
                                // console.log("coord_hit_list:", coord_hit)
                                break
                        }
                    }
                    else if ((algo_grid[i + 10].display === '💥') && ((algo_grid[i - 10].display !== '🌀') && (algo_grid[i - 10].display !== '☠️'))) {
                        if (algo_grid[i - 10].valeur === ship.emo) {
                            console.log("here:", ship.emo)
                            text = `${ship.name} ennemi est touché 🤕`
                            algo_grid[i - 10].display = '💥'
                    ...
                    if ((algo_grid[i - 10].display === '💥') && ((algo_grid[i + 10].display === '🌀') || algo_grid[i + 10].display === '☠️')) {
                        ...
                        coord_your_hit = coord_your_hit.reverse()
                        // console.log("coord_hit_list:", coord_hit)
                        i = coord_your_hit[coord_your_hit.length - 1]
                    ...
                    if (algo_grid[i + 10].display === '💥') {

                        coord_your_hit = coord_your_hit.reverse()
                        // console.log("coord_hit_list:", coord_hit)
                        i = coord_your_hit[coord_your_hit.length - 1]

                        if ((algo_grid[i + 10].valeur === ship.emo) && (algo_grid[i + 10].display !== '☠️')) {
                            console.log("here:", ship.emo)
                            text = `${ship.name} ennemi est touché 🤕`
                            algo_grid[i + 10].display = '💥'
                            ship.hit += 1
                ...
                if ((algo_grid[i].id[1] > 0) && (algo_grid[i].id[1] < 9)) {
                    ...
                    if ((algo_grid[i + 1].display === '💥') && ((algo_grid[i - 1].display !== '🌀') && (algo_grid[i - 1].display !== '☠️'))) {
                        if (algo_grid[i - 1].valeur === ship.emo) {
                            console.log("here:", ship.emo)
                            text = `${ship.name} ennemi est touché 🤕`
                            algo_grid[i - 1].display = '💥'
                    ...
                    else if ((algo_grid[i - 1].display === '💥') && ((algo_grid[i + 1].display !== '🌀') && (algo_grid[i + 1].display !== '☠️'))) {
                        if (algo_grid[i + 1].valeur === ship.emo) {
                            console.log("here:", ship.emo)
                            text = `${ship.name} ennemi est touché 🤕`
                            algo_grid[i + 1].display = '💥'
                    ...
                    if (algo_grid[i - 1].display === '💥') {
                        ...
                        if ((algo_grid[i - 1].valeur === ship.emo) && (algo_grid[i - 1].display !== '☠️')) {
                            ...
                            console.log("touché en bas")
                            coord_your_hit.push(i - 1)
                            console.log("coord_your_hit_list:", coord_your_hit)
                            let sunk = this.Check_sunk_you(algo_grid, ship, coord_your_hit)
                            if (sunk) {
                                text = sunk[0];
                                coord_your_hit = sunk[1]
